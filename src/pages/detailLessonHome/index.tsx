...
const DetailLessonHome = () => {
  ...
  const { data: dataVideo } = useQuery({
    queryKey: ["dataLessonVideo", id],
    queryFn: () => {
      return homeApi.getDetailLessonHomeVideo(id);
    },
    onSuccess: (data) => {
      setVideoLink(data?.data?.data?.video);
    },
      ...
      <div className="flex items-center mx-2 px-2 rounded-t-2xl -mt-1">
        {!!routes &&
          routes.map((item, index) => {
            let bgColor = item.key === "info" ? "#F26091" : "#e9636e";
            return (
              <div
                key={index}
            ...
            {location.state.isBelongProgess && !location.state.status ? (
              ...
              <div className=" px-2 pt-4 pb-2 grid grid-cols-3 items-center gap-2">
                ...
                <div
                  ...
                  style={{
                    backgroundColor:
                      selectBtnTop === "completed" ? "#e9636e" : "#DEDEDE",
                  }}
                ...
                <div
                  ...
                  style={{
                    backgroundColor:
                      selectBtnTop === "easily" ? "#e9636e" : "#DEDEDE",
                  }}
                ...
                <div
                  ...
                  style={{
                    backgroundColor:
                      selectBtnTop === "hard" ? "#e9636e" : "#DEDEDE",
                  }}
