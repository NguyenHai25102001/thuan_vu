        ...
        <div className="bg-gradient-to-b w-[80%] from-[#AEE9FC] to-main mx-4 px-4 rounded-[25px] py-2">
          <div className="flex items-center justify-center mb-1">
            ...
            <div className="h-[35px] flex items-center justify-center ml-1">
              {choose && (
                <span className="text-buttonHome mt-2 text-center text-xl font-normal">
                            ...
                            {!!item2?.video &&
                              item2?.video?.map((action, actionIndex) => {
                                return (
                                  <SwiperSlide
                                    key={actionIndex}
                                    className="flex flex-col justify-center items-center mr-3 border-[1px] border-solid border-main"
                                  >
                                    <div
                                      className="w-full"
                                      onClick={() =>
